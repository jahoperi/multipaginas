...
stm.markdown("<h1 style='text-align: justify; color: black;'>Introducción</h1>", unsafe_allow_html=True)
...
stm.markdown("<h1 style='text-align: justify; color: black;'>Objetivo</h1>", unsafe_allow_html=True)
...
stm.markdown("<h1 style='text-align: justify; color: black;'>Requerimientos</h1>", unsafe_allow_html=True)
stm.markdown("<h1 style='text-align: justify; color: black;'>Localización de cada CAP con latitud y longitud</h1>", unsafe_allow_html=True)
stm.markdown("<h1 style='text-align: justify; color: black;'>Número de personas atendidas de cada CAP por semana o en su caso por mes</h1>", unsafe_allow_html=True)
stm.markdown("<h1 style='text-align: justify; color: black;'>Número de personas que trabajan en cada CAP</h1>", unsafe_allow_html=True)
stm.markdown("<h1 style='text-align: justify; color: black;'>Número de habitantes por municipio</h1>", unsafe_allow_html=True)
stm.markdown("<h1 style='text-align: justify; color: black;'>Ubicar los CAP’s de la competencia</h1>", unsafe_allow_html=True)
stm.markdown("<h1 style='text-align: justify; color: black;'>Número de personas en el municipio con una CI</h1>", unsafe_allow_html=True)
stm.markdown("<h1 style='text-align: justify; color: black;'>Número de personas en el municipio afiliados a AFORE PENSIONISSSTE</h1>", unsafe_allow_html=True)
stm.markdown("<h1 style='text-align: justify; color: black;'>Número de traspasos por entidad</h1>", unsafe_allow_html=True)
stm.markdown("<h1 style='text-align: justify; color: black;'>Monto de traspasos</h1>", unsafe_allow_html=True)
